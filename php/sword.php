<?php
	...
	$testurl = "https://na01.alma.exlibrisgroup.com/sword/TR_INTEGRATION_INST/sd";
	...
	$testdepositurl = "https://na01.alma.exlibrisgroup.com/sword/TR_INTEGRATION_INST/col/1762816100000561";

	// The test atom entry to deposit
	$testatomentry = "client/test/test-files/atom_multipart/atom";

	// The second test atom entry to deposit
	$testatomentry2 = "client/test/test-files/atom_multipart/atom2";

	// The test atom multipart file to deposit
	$testmultipart = "client/test/test-files/atom_multipart_package";

	// The second test file to deposit
	$testmultipart2 = "client/test/test-files/atom_multipart_package2";

	// The test content zip file to deposit
	$testzipcontentfile = "client/test-files/atom_multipart_package2.zip";

    // A plain content file
    $testextrafile = "client/test/test-files/swordlogo.jpg";
	...
	require("./client/swordappclient.php");
